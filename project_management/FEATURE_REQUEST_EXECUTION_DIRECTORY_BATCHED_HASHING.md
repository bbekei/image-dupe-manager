...
| 8 | Run tests, verify | ✅ Done | Unit: 151 passed, 10 skipped. Integration Pass 2: 8 passed. Only failure is pre-existing `test_regression_wf6_manual_export_import_round_trip[hash_only]` (known issue in CONVENTIONS.md). |
